<%-- 
    Document   : saque
    Created on : 23/11/2018, 04:10:09
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="http://localhost:8080/BancoXPTO/saque.jsp">
...
//	else if(idDestino > 0 && valor >= 0){
		...
		if (fundos >= valor){
	//	    PreparedStatement saque = conn.prepareStatement("update Usuario set saldo = saldo + ? where id = ?");
	//	    saque.setDouble(1, valor);
	//	    saque.setInt(2, idDestino);
